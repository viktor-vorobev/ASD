...
public:
    ...
    ~SortedTableOnAVL() override = default;
    ...
    TVal& operator[](const TKey& key) override {
        ...
        // Поиск, вставка и повторный поиск для возврата ссылки
